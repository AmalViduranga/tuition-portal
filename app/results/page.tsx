...
export default function ResultsPage() {
  return (
    <div className="flex flex-col gap-8 md:gap-12 pb-10">
      <section className="relative overflow-hidden rounded-3xl border border-blue-100 bg-slate-900 p-8 text-white shadow-xl md:p-12 text-center">
        <div className="absolute inset-0 bg-gradient-to-tr from-blue-900 to-slate-900 opacity-50" />
        <div className="relative">
          <p className="inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-500/10 px-3 py-1 text-sm font-semibold text-blue-300">
          ...
          <p className="mt-4 text-lg text-blue-100/80 mx-auto max-w-2xl">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <div className="rounded-3xl border border-blue-100 bg-white p-8 shadow-sm">
           ...
           <div className="mb-8 p-6 bg-slate-50 rounded-2xl border border-slate-100">
             ...
             <p className="text-3xl font-extrabold text-blue-600">{pastResults.batch2024.results}</p>
        ...
        <div className="rounded-3xl border-2 border-blue-200 bg-gradient-to-br from-blue-50/20 to-blue-100/40 p-8 shadow-md relative">
           <div className="absolute -top-4 -right-4">
             <span className="inline-flex items-center gap-1 rounded-full bg-blue-600 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-white shadow-sm">
           ...
           <div className="mb-8 p-6 bg-white rounded-2xl border border-blue-100 shadow-sm">
             <p className="text-sm uppercase tracking-wider font-semibold text-slate-500 mb-2">Overall Results</p>
             <p className="text-3xl font-extrabold text-blue-600">{pastResults.batch2025.results}</p>
